...
export default function HeroSection() {
    ...
    const specialFeatures = [
        "Tasarım becerisi gerekmez",
        "Hızlı Üretim",
        "Yüksek tıklama oranına sahip şablonlar",
    ];
        ...
        <div className="relative flex flex-col items-center justify-center px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            >
                ...
                <p className="flex items-center gap-1">
                    <span>Oluşturacağınız ilk thumbnail ücretsiz</span>
            ...
            >
                Videolarınız için AI ile <span className="move-gradient px-3 rounded-xl text-nowrap">Thumbnail Oluşturun.</span>
            </motion.h1>
            <motion.p className="text-base text-center text-slate-200 max-w-lg mt-6"
                ...
                transition={{ delay: 0.2, type: "spring", stiffness: 320, damping: 70, mass: 1 }}
            >
                Tasarım için saatlerce zaman kaybetmeyi bırakın. Gelişmiş yapay zekamızla saniyeler içinde yüksek dönüşüm oranlı Thumbnail elde edin.</motion.p>
