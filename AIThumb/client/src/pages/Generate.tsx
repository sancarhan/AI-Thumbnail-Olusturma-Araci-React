            ...
            <div className={`space-y-6 ${id && "pointer-events-none"}`}>
              <div className="p-6 rounded-2xl bg-white/8 border border-white/12 shadow-xl space-y-6">
                <div>
                  ...
                  <p className="text-sm text-zinc-400">
                    Vizyonunuzu tanımlayın ve yapay zekanın onu hayata
                    geçirmesine izin verin.
                  </p>
                </div>
                ...
                <div className="space-y-5">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      maxLength={100}
                      placeholder="Örneğin, Daha İyi Ders Çalışma İçin İpucu"
              ...
              py-3 rounded-lg border border-white/12 bg-black/20 text-zinc-100 placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
                  ...
                  <div className="space-y-2">
                    <label className="block text-sm font-medium">
                      Ek İstemler{" "}
                      <span className="text-zinc-400 text-xs">(Opsiyonel)</span>
                    </label>
                    <textarea
                      value={additionalDetails}
                      onChange={(e) => setAdditionalDetails(e.target.value)}
                      rows={3}
                      placeholder="İstediğiniz özel unsurları, ruh halini veya stil tercihlerini ekleyin..."
